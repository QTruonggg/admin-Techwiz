...
import {  getdisagree } from "../../services/contract.service";
...
const Contractdisagree = (props) => {
    ...
    <main className="content">
      <Topbar/>
        <Box m="20px" >
        <Header title="LIST CONTRACTS DISAGREE " subtitle="LIST CONTRACTS DISAGREE " />
...
export default Contractdisagree;