...
import { edit_contract, get } from "../../services/contract.service";
...
const Contacts = (props) => {
    ...
    <main className="content">
      <Topbar/>
        <Box m="20px" >
        <Header title="LIST CONTRACTS" subtitle="LIST CONTRACTS" />
        <Link to={"/contractagree"}>
                                            <button style={{borderRadius:3, backgroundColor:"pink"}} className=" w-50 car__item-btn car__btn-details">
                                            Contract Agree
                                            </button> 
                                            </Link>
        <Link to={"/contractpayment"}>
                                            <button style={{borderRadius:3, backgroundColor:"pink"}} className=" w-50 car__item-btn car__btn-details">
                                            Contract Payment
                                            </button> 
        </Link>
        <Link to={"/contractdisagree"}>
                                            <button style={{borderRadius:3, backgroundColor:"pink"}} className=" w-50 car__item-btn car__btn-details">
                                            Contract Disagree
                                            </button> 
        </Link>
