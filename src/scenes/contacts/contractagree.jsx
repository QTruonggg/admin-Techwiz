...
import {  getagree } from "../../services/contract.service";
...
const Contractagree = (props) => {
    ...
    <main className="content">
      <Topbar/>
        <Box m="20px" >
        <Header title="LIST CONTRACTS AGREE " subtitle="LIST CONTRACTS AGREE " />
